                                        ...
                                        <div class="card-body">
                                            <div class="container">
                                                ...
                                                <div class="btn-i">
                                                    ...
                                                    <div class="dropdown">
                                                        <button class="btn btn-checkbox" type="button"
                                                            id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            Tampilkan Kolom
                                                            <span class="material-symbols-outlined" id="oi"
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <li>
                                                                <label class="dropdown-item">
                                                                    <input type="checkbox" class="column-toggle"
                                                                        data-column="image-column"> Gambar
                                                                </label>
                                                            </li>
                                                            <li>
                                                                <label class="dropdown-item">
                                                                    <input type="checkbox" class="column-toggle"
                                                                        data-column="subkontraktor-column">
                                                                    Sub-Kontraktor
                                                                </label>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    <div class="filter-button-group">
                                                        ...
                                                        <button class="btn btn-dropdown" class="btn-filter"
                                                            id="openFilterModal">
                                                        ...
                                                        <form method="GET" action="{{ route('export.pdf') }}"
                                                            id="export-pdf-form" class="ml-2">
                                                            <input type="hidden" name="subkontraktor"
                                                                value="{{ request()->input('subkontraktor') }}">
                                                            ...
                                                            <button type="submit" class="btn btn-dropdown">
                                                                <span class="material-symbols-outlined"
                                                                    style="font-size: 16px;"> print</span> Export PDF
                                                            </button>
                                                        </form>
                                                    </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($orders as $order)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a class="btn-edit"
                                                                            href="{{ url('edit_pesanan', $order->id) }}"
                                                                            title="Edit"><i
                ...
                <section class="modal-container-body">
                    <form method="GET" action="{{ route('orders.show') }}">
                            ...
                            <select class="form-control" id="subkontraktor" name="subkontraktor">
                                ...
                                @foreach ($subkontraktors as $subkontraktor)
                                    <option value="{{ $subkontraktor->subkontraktor_name }}"
                                        {{ request()->input('subkontraktor') == $subkontraktor->subkontraktor_name ? 'selected' : '' }}>
                        ...
                        <div class="modal-container-footer">
                            ...
                            <a style="text-decoration: none; color: black" href="{{ route('orders.show') }}"
